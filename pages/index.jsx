...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       How about moderating your own server with AlevBot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/oauth2/authorize?client_id=1210644404633731092&permissions=8&integration_type=0&scope=bot"}>
              <a
                className={
  ...
  <Link href={"https://top.gg/tr/bot/1210644404633731092"}>
...
Vote MusicMaker</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"AlevBot" }} />
